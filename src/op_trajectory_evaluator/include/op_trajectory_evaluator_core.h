...
protected:
  ...
  struct timespec m_PlanningTimer;
    ...
    // Wall filter parameters (turn intensity based, local to evaluator)
    bool   m_bEnableWallFilter;
    double m_WallTurnIntensityLevel1;
    double m_WallTurnIntensityLevel2;
    double m_WallTurnIntensityLevel3;
    double m_WallSkipDistGainLevel1;
    double m_WallSkipDistGainLevel2;
    double m_WallSkipDistGainLevel3;
    double m_WallSafetyAttenLevel2;
    double m_WallSafetyAttenLevel3;
    double m_WallBaseSkipDistance;  // base lateral skip distance for wall filtering

    double ComputeTurnIntensity();
    void FilterWallObjects(const std::vector<PlannerHNS::DetectedObject>& input,
